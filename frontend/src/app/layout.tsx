  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Head>
        ...
        <meta name="description" content="A simple message board. Let out your feelings." />
        <meta name="og:type" content="article" />
        <meta name="og:title" content="message board." />
        <meta name="og:description" content="A simple message board. Let out your feelings." />
        ...
        <meta name="twitter:description" content="A simple message board. Let out your feelings." />
