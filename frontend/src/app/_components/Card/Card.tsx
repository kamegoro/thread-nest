...
export const Card: React.FC<CardProps> = ({ id, name, date, children }) => {
  ...
  return (
    <div className={[styles.container, colorPalettes[randIndex].body, colorPalettes[randIndex].text].join(' ')}>
      ...
      <div className={styles.detail}>
        ...
        <div className={styles.action}>
          <CircleBtn icon={<Trash2 size={15} color="black" />} id={id} className="bg-white" onClick={onClick} />
        </div>
      </div>
    </div>
  );
